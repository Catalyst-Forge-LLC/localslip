...
- **named port registry / lease** — the mechanism. Not DNS. The slip metaphor stays secondary.
...
- Brand-metaphor budget: **slip** and **named port registry**. Do not ride harbor through every heading. Home may keep one `.dict` gloss of **slip** under the hero (noun: a boat's allotted place at a dock). The npm README may keep the same line as a blockquote. That is the definition, not a third heading.

...
- Cheap surfaces (draft): `docs/specs/cheap-surfaces.md`. B1–B5 plus quiet / recipe health / `--guess-all`. Tippy on the board for Open, copy, and recipe facts. `localberth quiet` stops listening `*-site` (dashboard stays).
